/**
 * Visitor hosts a list of visitor functions which visit AST (Abstract Syntax Tree) nodes
 * generated by Typescript compiler API. Inside each one of these functions, the implementation tells
 * how we translates a program construct from Typescript to another representation or language in general.
 */
...
export class Visitor {
    ...
    /**
     * Visit a source file as a starting point of translation
     * @param sourceFile 
     * @param scope 
     */
    ...
    public visitVariableDeclarationList(variableDeclarationList: ts.VariableDeclarationList, scope: Scope) {
        ...
        // Visit all the variable declarations from the list and return its corresponding IR values generated by LLVM IR builder
    ...
    public visitUnionType(unionTypeNode: ts.UnionTypeNode, scope: Scope) {
        // TODO: Need to reinstate the real type by bitcasting
        // Find the largest type among the union type and its size
    ...
    public visitEnumDeclaration(enumDeclaration: ts.EnumDeclaration, scope: Scope) {
        ...
        // Enum type is represented as int32 type in LLVM IR
    ...
    public visitMethodDeclaration(methodDeclaration: ts.MethodDeclaration, scope: Scope, specificTypes?: Type[]) {
        ...
        /* 
        * Insert a pointer to IR struct type generated with class declaration
        * for future access to the elements of the struct type in this method declaration
        */
        parameterNames.unshift('this');
        const structType = this.builder.getStructType(className);
